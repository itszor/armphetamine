              ...
              void* data)
{
  switch (inst.generic.type)
  {
    case 0:	// either data processing op, PSR tranfer or multiply
    {
      ...
      {
        switch (inst.mul.ident & 6)
        {
          case 0:
          {
            switch (inst.mul.ident2) /* bits 27...22 */
            {
              case 0:
              // it's a multiply
              ...
              case 1:
              fprintf(stderr, "Possible data-processing instruction?\n");
              abort();
          ...
          if (inst.mul.s==0)
          {
            fprintf(stderr, "Two-word transfer, unimplemented\n");
            abort();
          }
          else
          {
