...
#define environment_MemoryLimit           0
#define environment_UndefinedInstruction  1
#define environment_PrefetchAbort         2
#define environment_DataAbort             3
#define environment_AddressException      4
#define environment_OtherException        5
#define environment_Error                 6
#define environment_CallBack              7
#define environment_BreakPoint            8
#define environment_Escape                9
#define environment_Event                 10
#define environment_Exit                  11
#define environment_UnusedSWI             12
#define environment_ExceptionRegisters    13
#define environment_ApplicationSpace      14
#define environment_CurrentlyActiveObject 15
#define environment_UpCall                16

typedef struct {
  uint5 environment[18][3];
  uint3 vduqueue[12];
  uint5 vdulen, vduptr;
  uint5 escape;
  uint3 escapekey;
...
extern osstateinfo* riscosstate;

extern osstateinfo* riscos_initialise(void);
extern void riscos_stringcopy(meminfo* mem, uint5 to, uint5 from);
extern void riscos_vdu(osstateinfo* os, uint3 ch);
extern void riscos_readline(osstateinfo* os, meminfo* mem, registerinfo* reg);
extern void riscos_swi(osstateinfo* os, machineinfo* machine, uint5 num);
